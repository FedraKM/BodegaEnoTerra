...
function guardarConfiguracion() {
  ...
  const horario = document.getElementById("horario-atencion").value;
  const limite = document.getElementById("limite-reservas").value;
  const reservasActivas = document.getElementById("activar-reservas").checked;
  const autoPublicar = document.getElementById("auto-publicar-reseñas").checked;
  const frecuencia = document.getElementById("frecuencia-reportes").value;

  console.log("Configuración guardada:");
  console.log({ nombre, email, pass, horario, limite, reservasActivas, autoPublicar, frecuencia });
