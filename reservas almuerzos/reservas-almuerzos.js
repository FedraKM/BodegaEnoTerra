...
//cerrar formulario
document.getElementById('link-cerrarformulario').onclick = () => window.location.href = '../Reservas/reservas.html';

//boton enviar
document.getElementById('boton-enviar').onclick = () => window.location.href = '../Home/home.html';